...
<section id="about" className="py-20 px-6 max-w-6xl mx-auto">
  ...
  <div className="bg-green-50 rounded-lg shadow-lg p-8 text-gray-700 leading-relaxed mb-12">
    ...
    <p>
      We are proud to lead a company that remains deeply rooted in tradition while embracing modern innovation — delivering trusted, eco-friendly products that reconnect the world with India’s natural resources and champion sustainable farming for a better tomorrow.
    </p>
  </div>
